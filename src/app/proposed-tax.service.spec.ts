...
describe('ProposedTaxService', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [ProposedTaxService]
    });
  });

  it('should be created', inject([ProposedTaxService], (service: ProposedTaxService) => {
    expect(service).toBeTruthy();
  }));

  it('should calculate properly for 20000', inject([ProposedTaxService], (service: ProposedTaxService) => {
  ...
  it('should calculate properly for 75000', inject([ProposedTaxService], (service: ProposedTaxService) => {
  ...
  it('should calculate properly for 150000', inject([ProposedTaxService], (service: ProposedTaxService) => {
  ...
  it('should calculate properly for 200000', inject([ProposedTaxService], (service: ProposedTaxService) => {
